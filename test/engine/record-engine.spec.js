...
import {RECORDRTC, LIBVORBISJS, RECORDERJS, LAMEJS, OPUSRECORDER, OPUSMEDIARECORDER, VMSG, WEBMWASM, RECORD_PLUGINS, AUDIO_PLUGINS, VIDEO_PLUGINS, RecordEngine} from '../../src/js/engine/record-engine.js';
...
describe('engine.record-engine', () => {
    ...
    it('contain supported recorder plugin engines', () => {
        ...
        // all
        expect(RECORD_PLUGINS.length).toEqual(
            AUDIO_PLUGINS.length + VIDEO_PLUGINS.length
        );
    });
